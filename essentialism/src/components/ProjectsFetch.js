...
import projectsReducer from "../redux/reducer/reducer";
import { getData } from "../redux/action/action";
import { connect } from "react-redux";
import { axiosWithAuth } from "../utils/axiosWithAuth";
import { removeProject } from "../redux/action/action";
...
const ProjectsFetch = (props) => {
  ...
  return (
    <div>
      <h2 style={{ color: "whitesmoke", background: "#FF6484" }}>
        Projects List
      </h2>
      {props.projects.length > 0 ? (
        props.projects.map((project) => {
          return (
            ...
            >
              <h1
                style={{ margin: "5%", background: "whitesmoke", border: "2%" }}
              >
                {" "}
                Title: {project.title}{" "}
              </h1>
              ...
              <p style={{ color: "whitesmoke" }}>
                Value 1: {project.values[0].value_name}
              </p>
              <p style={{ color: "whitesmoke" }}>
                Value 2: {project.values[1].value_name}
              </p>
...
export default connect(mapStateToProps, { getData })(ProjectsFetch);
